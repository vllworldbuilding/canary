...
static constexpr int32_t MAP_MAX_CLIENT_VIEW_PORT_X = 19;
...
static constexpr int8_t MAP_MAX_LAYERS = 64;
static constexpr int8_t MAP_INIT_SURFACE_LAYER = 31; // (MAP_MAX_LAYERS / 2) -1
