...
enum ObjectCategory_t : uint8_t {
	...
	OBJECTCATEGORY_COPPER = 30,
	OBJECTCATEGORY_SOULCORES = 31,
	OBJECTCATEGORY_GAUNTLETS = 32,
	OBJECTCATEGORY_CROWN = 33,
	OBJECTCATEGORY_MANTLE = 34,
	OBJECTCATEGORY_COWL = 35,
	OBJECTCATEGORY_BELT = 36,
	OBJECTCATEGORY_EARRINGS = 37,
	OBJECTCATEGORY_ARMRING = 38,
	OBJECTCATEGORY_FIBULA = 39,
	OBJECTCATEGORY_DEFAULT = 40, // unassigned loot
