...
void LuaEnums::initConditionParamEnums(lua_State* L) {
	...
	registerEnum(L, CONDITION_PARAM_SKILL_METALWORKING);
	registerEnum(L, CONDITION_PARAM_SKILL_WOODWORKING);
	...
	registerEnum(L, CONDITION_PARAM_SKILL_LORE);
	registerEnum(L, CONDITION_PARAM_SKILL_INSCRIPTION);
	registerEnum(L, CONDITION_PARAM_SKILL_LANGUAGES);
	...
	registerEnum(L, CONDITION_PARAM_SKILL_METALWORKINGPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_WOODWORKINGPERCENT);
	...
	registerEnum(L, CONDITION_PARAM_SKILL_LOREPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_INSCRIPTIONPERCENT);
	registerEnum(L, CONDITION_PARAM_SKILL_LANGUAGESPERCENT);
...
void LuaEnums::initSkillEnums(lua_State* L) {
	...
	registerEnum(L, SKILL_METALWORKING);
	registerEnum(L, SKILL_WOODWORKING);
	registerEnum(L, SKILL_HUNTING);
	registerEnum(L, SKILL_FARMING);
	registerEnum(L, SKILL_COOKING);
	registerEnum(L, SKILL_CRAFTING);
	registerEnum(L, SKILL_HERBLORE);
	registerEnum(L, SKILL_ALCHEMY);
	registerEnum(L, SKILL_ARCHAEOLOGY);
	registerEnum(L, SKILL_MUSIC);
	registerEnum(L, SKILL_LORE);
	registerEnum(L, SKILL_INSCRIPTION);
	registerEnum(L, SKILL_LANGUAGES);
