...
bool IOLoginDataSave::savePlayerFirst(const std::shared_ptr<Player> &player) {
	...
	query << "`skill_metalworking` = " << player->skills[SKILL_METALWORKING].level << ",";
	query << "`skill_metalworking_tries` = " << player->skills[SKILL_METALWORKING].tries << ",";
	query << "`skill_woodworking` = " << player->skills[SKILL_WOODWORKING].level << ",";
	query << "`skill_woodworking_tries` = " << player->skills[SKILL_WOODWORKING].tries << ",";
	...
	query << "`skill_lore` = " << player->skills[SKILL_LORE].level << ",";
	query << "`skill_lore_tries` = " << player->skills[SKILL_LORE].tries << ",";
	query << "`skill_inscription` = " << player->skills[SKILL_INSCRIPTION].level << ",";
	query << "`skill_inscription_tries` = " << player->skills[SKILL_INSCRIPTION].tries << ",";
	query << "`skill_languages` = " << player->skills[SKILL_LANGUAGES].level << ",";
	query << "`skill_languages_tries` = " << player->skills[SKILL_LANGUAGES].tries << ",";
