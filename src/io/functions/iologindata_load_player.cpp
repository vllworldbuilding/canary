...
void IOLoginDataLoad::loadPlayerSkill(const std::shared_ptr<Player> &player, const DBResult_ptr &result) {
	...
	static const std::array<std::string, 27> skillNames = { "skill_fist", "skill_club", "skill_sword", "skill_axe", "skill_dist", "skill_shielding", "skill_fishing", "skill_mining", "skill_metalworking", "skill_woodworking", "skill_hunting", "skill_farming", "skill_cooking", "skill_crafting", "skill_herblore", "skill_alchemy", "skill_archaeology", "skill_music", "skill_lore", "skill_inscription", "skill_languages", "skill_critical_hit_chance", "skill_critical_hit_damage", "skill_life_leech_chance", "skill_life_leech_amount", "skill_mana_leech_chance", "skill_mana_leech_amount" };
	static const std::array<std::string, 27> skillNameTries = { "skill_fist_tries", "skill_club_tries", "skill_sword_tries", "skill_axe_tries", "skill_dist_tries", "skill_shielding_tries", "skill_fishing_tries", "skill_mining_tries", "skill_metalworking_tries", "skill_woodworking_tries", "skill_hunting_tries", "skill_farming_tries", "skill_cooking_tries", "skill_crafting_tries", "skill_herblore_tries", "skill_alchemy_tries", "skill_archaeology_tries", "skill_music_tries", "skill_lore_tries", "skill_inscription_tries", "skill_languages_tries", "skill_critical_hit_chance_tries", "skill_critical_hit_damage_tries", "skill_life_leech_chance_tries", "skill_life_leech_amount_tries", "skill_mana_leech_chance_tries", "skill_mana_leech_amount_tries" };
