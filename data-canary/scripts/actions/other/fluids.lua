...
local fluidMessage = {
	...
	[FLUID_SALTWATER] = "Urgh...", -- salt water
	[FLUID_WINE] = "Aah...", -- wine
	[FLUID_BEER] = "Gulp.", -- beer
	[FLUID_MUD] = "Gulp.", -- mud
	[FLUID_BLOOD] = "Urgh!", -- blood
	[FLUID_SLIME] = "Gulp.", -- slime
	[FLUID_OIL] = "Urgh!", -- oil
	[FLUID_URINE] = "Gasp.", -- urine
	[FLUID_MILK] = "Aaaah...", -- milk
	[FLUID_MANA] = "Aaaah...", -- mana fluid
	[FLUID_LIFE] = "Mmmh.", -- life fluid
	[FLUID_LEMONADE] = "Aah...", -- lemonade
	[FLUID_RUM] = "Mmmh.", -- rum
	[FLUID_FRUITJUICE] = "Mmmh.", -- fruit juice
	[FLUID_COCONUTMILK] = "Aah...", -- coconut milk
	[FLUID_MEAD] = "Gulp.", -- mead
	[FLUID_TEA] = "Urgh!", -- tea
	[FLUID_CANDY] = "Mmmh.", -- candy
	[FLUID_CHOCOLATE] = "Mmmh.", -- chocolate
	[FLUID_FRESHWATER] = "Gulp.", -- fresh water
}
