...
CREATE TABLE IF NOT EXISTS `players` (
    ...
    `skill_metalworking` int(10) UNSIGNED NOT NULL DEFAULT '10',
    `skill_metalworking_tries` bigint(20) UNSIGNED NOT NULL DEFAULT '0',
    `skill_woodworking` int(10) UNSIGNED NOT NULL DEFAULT '10',
    `skill_woodworking_tries` bigint(20) UNSIGNED NOT NULL DEFAULT '0',
    ...
    `skill_lore` int(10) UNSIGNED NOT NULL DEFAULT '10',
    `skill_lore_tries` bigint(20) UNSIGNED NOT NULL DEFAULT '0',
    `skill_inscription` int(10) UNSIGNED NOT NULL DEFAULT '10',
    `skill_inscription_tries` bigint(20) UNSIGNED NOT NULL DEFAULT '0',
    `skill_languages` int(10) UNSIGNED NOT NULL DEFAULT '10',
    `skill_languages_tries` bigint(20) UNSIGNED NOT NULL DEFAULT '0',
